...
public class BillManager extends AbstractManager<Bill> {
    ...
    @Override
    public SortingOption<Bill> getSortingOption() {
        return SortingConfig.getBillSortingOption();
    }

    @Override
    public void setSortingOption(SortingOption<Bill> sortingOption) {
        SortingConfig.setBillSortingOption(sortingOption);
    }
